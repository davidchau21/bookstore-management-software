 ...
 * @author TuanPC
 */
public class GUI_ThemNhaXuatBan extends javax.swing.JFrame implements ActionListener{
	...
	private Dao_NhaXuatBan daoNXB;
    /**
     * Creates new form GUI_ThemNhaXuatBan
     */
    public GUI_ThemNhaXuatBan() {
		...
		lbMaNXB.setText(daoPhatSinhMa.getMaNXB());
		lbMaNXB.setForeground(Color.white);
		lbMaNXB.setFont(new Font("Arial", Font.BOLD, 16));
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Thêm Nhà Xuất Bản");
...
//        });
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lbMaNXB, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbMaNXB, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtTenNXB, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(37, 37, 37)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_ThemNhaXuatBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_ThemNhaXuatBan().setVisible(true);
            }
        });
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(cbbTinhTP)) {
			...
			String maNCC = lbMaNXB.getText();
			String tenNCC = txtTenNXB.getText();
			...
			NhaXuatBan ncc = new NhaXuatBan(maNCC, tenNCC, sdt, new DiaChi(tp, quan, phuong));
			if (GUI_NhaXuatBan.edit == 1) {
				if (regex()) {
					if (daoNXB.themNXB(ncc)) {
						JOptionPane.showMessageDialog(null, "Thêm thành công nhà xuất bản " + tenNCC);
						GUI_NhaXuatBan.updateTable();
						dispose();
					} else if (!daoNXB.themNXB(ncc)) {
						JOptionPane.showMessageDialog(null, "Số điện thoại đã được dùng");
					}
				}

			} else if (GUI_NhaXuatBan.edit == 2) {
				if (regex()) {
					sdt = "";
					if (daoNXB.suaNXB(ncc)) {
						JOptionPane.showMessageDialog(null, "Sửa thành công nhà xuất bản " + tenNCC);
						GUI_NhaXuatBan.updateTable();
						dispose();
					} else if (!daoNXB.suaNXB(ncc)) {
						JOptionPane.showMessageDialog(null, "Số điện thoại đã được dùng");
	...
	private boolean regex() {
		...
		String regexTenNXB = "^[ A-Za-za-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂẾưăạảấầẩẫậắằẳẵặẹẻẽềềểếỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ]+$";
		String regexSdt = "0[2|3|5|7|8|9][0-9]{8}";
		if (!tenNXB.matches(regexTenNXB)) {
	...
	public Vector<String> getDsquanHuyen() {
		return dsquanHuyen;
	}

	public void setDsquanHuyen(Vector<String> dsquanHuyen) {
		this.dsquanHuyen = dsquanHuyen;
	}

	public Vector<String> getDsphuongXa() {
		return dsphuongXa;
	}

	public void setDsphuongXa(Vector<String> dsphuongXa) {
		this.dsphuongXa = dsphuongXa;
	}

	public Vector<String> getDstinhTP() {
		return dstinhTP;
	}

	public void setDstinhTP(Vector<String> dstinhTP) {
		this.dstinhTP = dstinhTP;
	}

	public Dao_DiaChi getDaoDiaChi() {
		return daoDiaChi;
	}

	public void setDaoDiaChi(Dao_DiaChi daoDiaChi) {
		this.daoDiaChi = daoDiaChi;
	}
	...
	public Dao_NhaXuatBan getDaoNXB() {
		return daoNXB;
	}

	public void setDaoNXB(Dao_NhaXuatBan daoNXB) {
		this.daoNXB = daoNXB;
	}
	...
	public javax.swing.JLabel getLbMaNXB() {
		return lbMaNXB;
	}

	public void setLbMaNXB(javax.swing.JLabel lbMaNXB) {
		this.lbMaNXB = lbMaNXB;
	}
	...
	public javax.swing.JTextField getTxtTenNXB() {
		return txtTenNXB;
	}

	public void setTxtTenNXB(javax.swing.JTextField txtTenNXB) {
		this.txtTenNXB = txtTenNXB;
	}
