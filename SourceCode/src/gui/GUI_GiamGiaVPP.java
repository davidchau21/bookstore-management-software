 ...
 * @author Admin
 */
public class GUI_GiamGiaVPP extends javax.swing.JFrame implements ActionListener{
	private Dao_SanPham dao_SanPham = new Dao_SanPham();
    /**
     * Creates new form GUI_GiamGia
     */
    public GUI_GiamGiaVPP() {
        initComponents();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnHuy)) {
			...
			dao_SanPham.suaGiamGia(GUI_VanPhongPham.getTable().getValueAt(GUI_VanPhongPham.getTable().getSelectedRow(), 0).toString(), 
